...
namespace IceCoffee.DbCore.Repositories
{
    ...
    public class SQLiteRepository<TEntity> : RepositoryBase<TEntity>
    {
        ...
        {
            return InsertIgnoreBatchByTableName(TableName, entities, useTransaction);
        }
        ...
        {
            return ReplaceIntoByTableName(TableName, entity);
        }

        public override int ReplaceIntoBatch(IEnumerable<TEntity> entities, bool useTransaction = false)
        {
            return ReplaceIntoBatchByTableName(TableName, entities, useTransaction);
        }
