...
{
    public abstract class RepositoryBaseGuid<TEntity, TDbConnection> : RepositoryBase<TEntity, Guid>, IDisposable
            where TEntity : EntityBase<Guid> where TDbConnection : IDbConnection, new()
    {
        #region 构造数据库连接
        ...
        public RepositoryBaseGuid(ref IDbTransaction Transaction)
        {
        ...
        public RepositoryBaseGuid(string connectionString, bool useConnectionPool)
        {
